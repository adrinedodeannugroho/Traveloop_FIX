...
<section class="hero-section position-relative" id="hero">
  ...
  <div class="container hero-content text-center" style="padding-top: 80px;">
    ...
    <p class="hero-sub fs-5 text-light opacity-75 mb-5 mx-auto" style="max-width: 700px;">
    ...
    <div class="hero-search-wrap mx-auto bg-white p-2 rounded-pill shadow-lg" style="max-width: 600px;">
      <div class="d-flex align-items-center">
        ...
        <input type="text" id="heroSearch" class="form-control border-0 shadow-none bg-transparent py-3 px-3" placeholder="Ketik nama tempat atau kota..." autocomplete="off"/>
        <button class="btn btn-warning rounded-pill px-4 py-2 fw-bold" onclick="doHeroSearch()">Eksplorasi</button>
      </div>
    </div>
  ...
  <div class="hero-scroll-hint opacity-50">
      <span class="small text-uppercase tracking-wider">Scroll</span>
      <div class="scroll-line mt-2"></div>
  </div>
</section>

<section class="stats-strip bg-dark text-white py-5 border-top border-warning border-4">
  <div class="container">
    <div class="row g-4 text-center">
      <div class="col-6 col-md-3">
          <div class="p-3">
              <i class="bi bi-geo-alt-fill display-5 text-warning mb-3 d-block opacity-75"></i>
              <span class="stat-num display-4 fw-bold mb-1">50+</span>
              <span class="stat-label text-uppercase small tracking-wider text-white-50">Destinasi</span>
          </div>
      </div>
      <div class="col-6 col-md-3">
          <div class="p-3 border-start border-secondary">
              <i class="bi bi-map-fill display-5 text-warning mb-3 d-block opacity-75"></i>
              <span class="stat-num display-4 fw-bold mb-1">5</span>
              <span class="stat-label text-uppercase small tracking-wider text-white-50">Kabupaten</span>
          </div>
      </div>
      <div class="col-6 col-md-3">
          <div class="p-3 border-start border-secondary">
              <i class="bi bi-star-fill display-5 text-warning mb-3 d-block opacity-75"></i>
              <span class="stat-num display-4 fw-bold mb-1">1K+</span>
              <span class="stat-label text-uppercase small tracking-wider text-white-50">Ulasan Positif</span>
          </div>
      </div>
      <div class="col-6 col-md-3">
          <div class="p-3 border-start border-secondary">
              <i class="bi bi-people-fill display-5 text-warning mb-3 d-block opacity-75"></i>
              <span class="stat-num display-4 fw-bold mb-1">10K+</span>
  ...
  <div class="container">
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-6 col-md-4 col-lg-2">
          <a href="explore.php?cat=nature" class="cat-card bg-white shadow-sm border-0 rounded-4 p-4 text-center d-block text-decoration-none transition hover-zoom">
              <div class="cat-icon-wrap mx-auto mb-3" style="--cat-color:#2d9e6b; width: 70px; height: 70px; border-radius: 20px;"><i class="bi bi-tree fs-2"></i></div>
              <span class="cat-name fw-bold text-dark">Alam Segar</span>
          </a>
      </div>
      <div class="col-6 col-md-4 col-lg-2">
          <a href="explore.php?cat=beach" class="cat-card bg-white shadow-sm border-0 rounded-4 p-4 text-center d-block text-decoration-none transition hover-zoom">
              <div class="cat-icon-wrap mx-auto mb-3" style="--cat-color:#0ea5e9; width: 70px; height: 70px; border-radius: 20px;"><i class="bi bi-water fs-2"></i></div>
              <span class="cat-name fw-bold text-dark">Pantai Biru</span>
          </a>
      </div>
      <div class="col-6 col-md-4 col-lg-2">
          <a href="explore.php?cat=mountain" class="cat-card bg-white shadow-sm border-0 rounded-4 p-4 text-center d-block text-decoration-none transition hover-zoom">
              <div class="cat-icon-wrap mx-auto mb-3" style="--cat-color:#7c5c3b; width: 70px; height: 70px; border-radius: 20px;"><i class="bi bi-snow2 fs-2"></i></div>
              <span class="cat-name fw-bold text-dark">Pegunungan</span>
          </a>
      </div>
      <div class="col-6 col-md-4 col-lg-2">
          <a href="explore.php?cat=cultural" class="cat-card bg-white shadow-sm border-0 rounded-4 p-4 text-center d-block text-decoration-none transition hover-zoom">
              <div class="cat-icon-wrap mx-auto mb-3" style="--cat-color:#e88a22; width: 70px; height: 70px; border-radius: 20px;"><i class="bi bi-building-fill fs-2"></i></div>
              <span class="cat-name fw-bold text-dark">Seni & Budaya</span>
          </a>
      </div>
      <div class="col-6 col-md-4 col-lg-2">
          <a href="explore.php?cat=historical" class="cat-card bg-white shadow-sm border-0 rounded-4 p-4 text-center d-block text-decoration-none transition hover-zoom">
              <div class="cat-icon-wrap mx-auto mb-3" style="--cat-color:#9b4f96; width: 70px; height: 70px; border-radius: 20px;"><i class="bi bi-bank2 fs-2"></i></div>
              <span class="cat-name fw-bold text-dark">Situs Sejarah</span>
          </a>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        ...
        <h2 class="fw-bold display-6 mb-4">Bingung Mau Kemana Saja Hari Ini?</h2>
...
<section class="cta-banner my-5 rounded-5 mx-3 mx-lg-5 shadow-lg position-relative overflow-hidden" style="background: linear-gradient(135deg, #1e293b, #0f172a); padding: 5rem 2rem;">
  <div class="position-absolute top-0 end-0 opacity-10 p-5">
      <i class="bi bi-compass" style="font-size: 20rem;"></i>
  </div>
  <div class="container text-center position-relative z-1">
    <h2 class="cta-title text-white mb-3 fw-bold display-6">Siap Mengembangkan Ekosistem Wisata?</h2>
    <p class="cta-sub text-light mb-4 mx-auto lead" style="max-width: 600px;">Bergabunglah sebagai mitra pengelola. Tingkatkan eksposur destinasi atau layanan kuliner Anda ke ribuan wisatawan di Barlingmascakeb.</p>
    <a href="contact.php" class="btn btn-warning btn-lg fw-bold px-5 rounded-pill shadow-sm">
